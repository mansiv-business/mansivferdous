          ...
          <div>
            <article>
              <div>
                ...
                <p className="p" >Unlike others I don’t just see websites as a fancy place to discover businesses. That is why
            ...
            <article>
              <div>
                ...
                <p className="p" >Most designers focus on UI and UX only. But just animations and wonderful layout can’t
            ...
            <article>
              <div>
                ...
                <p className="p" >SEO is no longer limited to google search. That is why I focus on websites that can be
            ...
            <article>
              <div>
                ...
                <p className="p" >An unoptimized website with heavy animations can make you lose clients. And that is where I
            ...
            <article>
              <div>
                ...
                <p className={`${styles.serviceDiv5} p`}>Hosting a website might be problematic after buying. And that is why I provide further
